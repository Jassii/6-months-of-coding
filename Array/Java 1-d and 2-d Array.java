...
class Complete
{
    public static ArrayList<Integer> array(int a[][], int b[], int n)
    {
        ...
        //first finding the sum of the diagnols of the 2-D array.
        int i,j;
        int sum=0;
        ...
        //now its time to find the max of the 'b' array.
        Arrays.sort(b); //Dual-Pivot Quicksort algorithm (ascending order)
        
        int max = b[n-1]; //this will be the maximum element..
