...
class Solution 
{
    int countZeroes(int[] arr, int n) 
    {
        ...
        //1's are placed first..and then 0's are placed..
        //so it is better to start from the end..
        //if it encounters "1"..then simply break it..
        ...
        for(i=n-1;i>=0;i--)
        {
            ...
            else //so no need to traverse the whole array..
            {
                break;
            }
        }
